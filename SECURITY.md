...
Replace this section with the supported versions for `failureseed`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `failureseed` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in failureseed.
